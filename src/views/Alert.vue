...
<div class="">
  <Project/>
    ...
    <div class="relative isolate overflow-hidden bg-primary py-16 sm:py-24 lg:py-32">
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
          <div class="max-w-xl lg:max-w-lg">
            <h2 class="text-4xl font-semibold tracking-tight text-white">LynxxDev</h2>
            ...
            <div class="mt-6 flex max-w-md gap-x-4">
              ...
              <input id="email-address" name="email" type="email" autocomplete="email" required="" class="min-w-0 flex-auto rounded-md bg-primary px-3.5 py-2 text-base text-white outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6" placeholder="Enter your email" />
          ...
          <dl class="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
            <div class="flex flex-col items-start">
              <div class="rounded-md bg-white/5 p-2 ring-1 ring-white/10">
                <CalendarDaysIcon class="size-6 text-white" aria-hidden="true" />
              </div>
            ...
            <div class="flex flex-col items-start">
              <div class="rounded-md bg-white/5 p-2 ring-1 ring-white/10">
                <HandRaisedIcon class="size-6 text-white" aria-hidden="true" />
              </div>
      ...
      @click="scrollToTop" class="absolute animate-bounce right-3 bottom-0 cursor-pointer">
      <svg
        ...
        stroke-width="1.5"
        stroke="currentColor"
        class="size-10 text-white border p-2 rounded-full"
      >
        <path
  ...
  export default {
    components: { CalendarDaysIcon, HandRaisedIcon, Project },
    data() {
      return {
        showButton: false,
      };
